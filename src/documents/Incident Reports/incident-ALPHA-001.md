...
permalink: /documents/incident-alpha-001/
...
{% sectionHeader "INCIDENT REPORT ALPHA 001" %}
Skip Gate Down
{% endsectionHeader %}
...
Telemetry indicates interference consistent with GOI {% redact 12 %}. Hostile frames were engaged and neutralized during the operation, resulting in minor secondary damage to *Alpspitze*.
...
- **Pilot:** Val  
  **STATUS:** Wounded (cosmetic)

- **Pilot:** Karl  
  **STATUS:** Wounded (augmentics required)

### Assets

- **CALLSIGN:** HAWK-3  
  **TYPE:** IPS-N BLACKBEARD  
  **STATUS:** Operational (moderate damage)

- **CALLSIGN:** MIRAGE-1  
  **TYPE:** SSC METALMARK  
  **STATUS:** Disabled (reactor breach)
