...
{% sectionHeader "Union, and the Galaxy" %}
To choke the stars with the living.
{% endsectionHeader %}
...
<div class="card">
  {% sectionHeader "The Utopian Pillars" %}
  For which we Strive
  {% endsectionHeader %}
...
ThirdComm's eternal task is to repairing this grievous wound to humanity's spirit, and avoiding making the same mistakes.
